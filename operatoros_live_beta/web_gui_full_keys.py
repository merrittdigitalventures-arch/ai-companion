...
GUIDE_TEXT = {
    "openai_key": "Get your OpenAI API key at https://platform.openai.com/account/api-keys",
    "x_bearer": "X (Twitter) Bearer Token: https://developer.twitter.com/en/docs/authentication/oauth-2-0/bearer-tokens",
    "x_consumer_key": "X (Twitter) Consumer Key: https://developer.twitter.com/en/portal/dashboard",
    "x_consumer_secret": "X (Twitter) Consumer Secret: https://developer.twitter.com/en/portal/dashboard",
    "x_access_id": "X Access Client ID: create a developer App in Twitter Developer Portal",
    "x_access_secret": "X Access Client Secret: create a developer App in Twitter Developer Portal",
...
<html>
<head>
    <title>OperatorOS – Credentials</title>
    <style>
...
@app.route("/")
def index():
    return render_template_string(HTML_TEMPLATE, REQUIRED_KEYS=REQUIRED_KEYS, GUIDE_TEXT=GUIDE_TEXT)
